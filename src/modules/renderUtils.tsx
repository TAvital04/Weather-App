import style from "../styles/renderUtils.module.css"
        ...
        <div className = {style.contents}>
            ...
            <div className = {style.body}>
                <div className = {style.subContents}>
                    ...
                    <div className = {`${style.subBody} ${style.body} ${style.bodyText}`}>{windSpeed} {unit}</div>
                </div>

                <div className = {style.subContents}>
                    <div className = {style.subHeading}>Direction</div>
                    <div className = {`${style.subBody} ${style.body} ${style.bodyText}`}>{direction}</div>
                </div>
            </div>
        </div>
    )
        ...
        <div className = {style.contents}>
            ...
            <div className = {style.body}>
                <div className = {style.subContents}>
                    ...
                    <div className = {`${style.subBody} ${style.body} ${style.bodyText}`}>{sunrise}</div>
                </div>

                <div className = {style.subContents}>
                    <div className = {style.subHeading}>Sets</div>
                    <div className = {`${style.subBody} ${style.body} ${style.bodyText}`}>{sunset}</div>
                </div>
            </div>
        </div>
    )
